        ...
        <div className="backdrop-blur-2xl bg-white/10 border border-white/20 rounded-[40px] p-8 md:p-12 shadow-2xl">
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-3 gap-4">
              {/* Google */}
              <button className="flex items-center justify-center bg-white rounded-xl py-3 hover:bg-gray-100 transition-all shadow-md">
              ...
              {/* GitHub */}
              <button className="flex items-center justify-center bg-white rounded-xl py-3 hover:bg-gray-100 transition-all shadow-md text-black">
                <Github size={24} />
              </button>
              {/* Facebook */}
              <button className="flex items-center justify-center bg-white rounded-xl py-3 hover:bg-gray-100 transition-all shadow-md">
