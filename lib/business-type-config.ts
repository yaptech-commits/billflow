...
export const BUSINESS_TYPE_CONFIG: Record<BusinessType, BusinessTypeConfig> = {
  ...
  hotel: {
    label: "Hotel",
    description: "Property operations, reservations, front desk, and guest billing",
    pages: [
      "/dashboard",
      "/hotel/rooms",
      "/hotel/reservations",
    ...
    features: ["room-management", "rate-plans", "tax-rules", "reservations", "front-desk", "guest-profiles", "group-bookings", "guest-billing", "reporting"],
  },
  coldstore: {
    label: "Coldstore",
